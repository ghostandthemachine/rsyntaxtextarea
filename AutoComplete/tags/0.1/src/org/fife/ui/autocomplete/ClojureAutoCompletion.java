 ...
 * 12/21/2008
 *
 * ClojureAutoCompletion.java - Handles auto-completion for a text component.
...
/**
 * Adds ClojureAutoCompletion to a text component.  Provides a popup window with a
 ...
 * popup Window.
 */
public class ClojureAutoCompletion implements HierarchyListener {
	 ...
	 */
	private static final String PARAM_COMPLETE_KEY = "ClojureAutoCompletion.FunctionStart";

	/**
	 * Whether debug messages should be printed to stdout as ClojureAutoCompletion
	 * runs.
	 */
	 ...
	 *        <code>null</code>.
	 */
	public ClojureAutoCompletion(CompletionProvider provider) {
	...
	/**
	 * Returns whether debug is enabled for ClojureAutoCompletion.
	 *
	...
	/**
	 * Returns the text component for which ClojureAutoCompletion is enabled.
	 *
	 * @return The text component, or <code>null</code> if this
	 *         {@link ClojureAutoCompletion} is not installed on any text component.
	...
	/**
	 * Determines whether debug should be enabled for the ClojureAutoCompletion
	...
	private static final boolean initDebug() {
		boolean debug = false;
		try {
			debug = Boolean.getBoolean("ClojureAutoCompletion.debug");
...
*/
	...
	/**
	 * Installs this ClojureAutoCompletion on a text component.  If this
	 * {@link ClojureAutoCompletion} is already installed on another text component,
	...
	/**
	 * Returns whether ClojureAutoCompletion is enabled.
	 *
	 * @return Whether ClojureAutoCompletion is enabled.
	...
	/**
	 * Sets whether ClojureAutoCompletion is enabled.
	 *
	 * @param enabled Whether ClojureAutoCompletion is enabled.
	...
	/**
	 * Uninstalls this ClojureAutoCompletion from its text component.  If it is not
	 ...
	 * before ClojureAutoCompletion was installed.
	 *
	...
	/**
	 * The <code>Action</code> that displays the popup window if ClojureAutoCompletion
	 * is enabled.
	 *
	 * @author Robert Futrell
	 * @version 1.0
